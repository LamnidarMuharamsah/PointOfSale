...
<html>
  <head>
	...
	<meta name="description" content="Produk By Nidar Muharamsah">
    <meta name="author" content="Nidar Muharamsah">
  ...
  <body class="login-bg" style=" background-color:#FFF8DC;">
		...
		<div class="row">
			...
			<div class="col-md-4 col-md-offset-4">
				...
				<div class="login-wrapper">
			        ...
			        <div class="box" style="background-color:#191970">

			            <div class="content-wrap">

			                <img  width="310px" src="<?php echo base_url().'assets/img/logob.png'?>"/>
